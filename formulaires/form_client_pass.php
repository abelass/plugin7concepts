...
function formulaires_form_client_pass_charger_dist($id_auteur='new', $retour='', $associer_objet='', $config_fonc='auteurs_edit_config2', $row=array(), $hidden=''){
 ...
 */
function formulaires_form_client_pass_identifier_dist($id_auteur='new', $retour='', $associer_objet='', $config_fonc='auteurs_edit_config2', $row=array(), $hidden=''){
...
function formulaires_form_client_pass_verifier_dist($id_auteur='new', $retour='', $associer_objet='', $config_fonc='auteurs_edit_config2', $row=array(), $hidden=''){
...
// http://doc.spip.org/@inc_editer_mot_dist
function formulaires_form_client_pass_traiter_dist($id_auteur='new', $retour='', $associer_objet='', $config_fonc='auteurs_edit_config2', $row=array(), $hidden=''){
	...
	if ($associer_objet AND $id_auteur=$res['id_auteur']){
		...
		if ($objet AND $id_objet AND autoriser('modifier',$objet,$id_objet)){
			include_spip('action/form_client_pass');
