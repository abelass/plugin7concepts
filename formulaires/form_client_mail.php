...
function formulaires_form_client_mail_charger_dist($id_auteur='new', $retour='', $associer_objet='', $config_fonc='auteurs_edit_config', $row=array(), $hidden=''){
 ...
 */
function formulaires_form_client_mail_identifier_dist($id_auteur='new', $retour='', $associer_objet='', $config_fonc='auteurs_edit_config', $row=array(), $hidden=''){
...
function formulaires_form_client_mail_verifier_dist($id_auteur='new', $retour='', $associer_objet='', $config_fonc='auteurs_edit_config', $row=array(), $hidden=''){
...
// http://doc.spip.org/@inc_editer_mot_dist
function formulaires_form_client_mail_traiter_dist($id_auteur='new', $retour='', $associer_objet='', $config_fonc='auteurs_edit_config', $row=array(), $hidden=''){
	...
	if ($associer_objet AND $id_auteur=$res['id_auteur']){
		...
		if ($objet AND $id_objet AND autoriser('modifier',$objet,$id_objet)){
			include_spip('action/form_client_mail');
